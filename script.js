...
const ADMIN_CREDENTIALS = {
    username: 'fahadkhan111',
    password: 'fahadkhan111'
};
...
function showSection(sectionName) {
    // Hide all sections
    const sections = ['home', 'products', 'cart', 'checkout', 'order-confirmation', 'contact', 'admin-panel', 'admin-login'];
    ...
    // Handle admin section with authentication
...
function logoutAdmin() {
    ...
    // Hide admin panel and show home
